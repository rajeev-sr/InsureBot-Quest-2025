...
def script():
    ...
    policy_holder_name=customer_details["policy_holder_name"]
    policy_number=customer_details["policy_number"]
    policy_start_date=customer_details["policy_start_date"]
    total_premium_paid=customer_details["total_premium_paid"]
    product_name=customer_details["product_name"]
    outstanding_amount=customer_details["outstanding_amount"]
    premium_due_date=customer_details["premium_due_date"]
    sum_assured=customer_details["sum_assured"]
    fund_value=customer_details["fund_value"]

    script=f"""Conversation Flow:
        ...
        and you will be able to download the policy bond. Proceed to Branch 9.0
        ...
        If the Customer respond anything,
        ...
        If the Customer respond "yes", proceed to Branch 5.0
        If the Customer respond "no", proceed to Branch 9.0
        ...
        if not then got to Branch 9.0Caller: I’ll update the details in our CRM.
        proceed to Branch 9.0
